...
from line import Line, get_perspective_transform
import numpy as np
...
class LaneDetector:
    ...
    def onchange_th_mag_Y(self,pos):
        return self._th_mag_Y 

    def onchange_th_dir_X(self,pos):
        return self._th_mag_X 

    def onchange_th_dir_Y(self,pos):
        return self._th_mag_Y 

    def onchange_th_h_X(self,pos):
        return self._th_h_X 

    def onchange_th_h_Y(self,pos):
        return self._th_h_Y 

    def onchange_th_l_X(self,pos):
        return self._th_l_X 

    def onchange_th_l_Y(self,pos):
        return self._th_l_Y 

    def onchange_th_s_X(self,pos):
        return self._th_s_X 

    def onchange_th_s_Y(self,pos):
        return self._th_s_Y 
